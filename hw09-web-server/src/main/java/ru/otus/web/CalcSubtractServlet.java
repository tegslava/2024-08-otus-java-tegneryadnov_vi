...
@WebServlet(name = "CalcSubtractServlet", urlPatterns = "/sub")
public class CalcSubtractServlet extends HttpServlet {
    private static final Logger logger = LoggerFactory.getLogger(CalcSubtractServlet.class);
